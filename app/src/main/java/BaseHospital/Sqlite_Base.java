...
public class Sqlite_Base extends SQLiteOpenHelper {
    ...
    public void insetarReg(String nom, String correo, String clave ,Integer tipo, String esp ,String nit, String dui,String tel, String fecha, String direccion ,Integer est){
